...
public class MyCardGame
{
    public static void main( String[] args)
    {
        ...
        } while ( selection != MENU_EXIT && game.isGameOver() != true);
        ...
        if(game.isGameOver())
        {
            ...
            {
                System.out.println();
                System.out.println("Winner of the game is: " + game.getWinners()[i].getName()); 
            }
    ...
    /**
     * this method plays the card by taking the top card from the player hand
     * @param p is the player we want to play the card
     * @param game is the cardGame that player plays in it
     * @return true if player have been succesfuly played the card
    */
    private static boolean play( Player p, CardGame game)
    {
        ...
        {
            System.out.println();
            System.out.println(p.getName() + " played the card: " + c);
        }
